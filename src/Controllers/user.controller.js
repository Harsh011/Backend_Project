...
const uppdateAccountDetails = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(
      new ApiError(200, user, "Account details has been update successfully")
    );
});
...
const updateUserAvatar = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, user, "Update avatar has been successfull"));
});
...
const updateCoverImage = asyncHandler(async (req, res) => {
  ...
  res
    .status(200)
    .json(
      new ApiResponse(200, user, "Cover Image has been update successfully")
    );
});
export {
  registerUser,
